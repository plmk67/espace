...
const Home = () => {
  ...
  const [loadedFavourite, setFavouritePlaces] = useState();
  ...
  return (
    <div className="flex justify-center bg-grey-100 pt-4">
      <div className="px-4 grid justify-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 ">
        {isLoading ? (
